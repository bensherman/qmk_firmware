 ...
 * |--------+------+------+------+------+--------------|           |------+------+------+------+------+------+--------|
 * | Tab    |   Q  |   W  |   E  |   R  |   T  |CtrlAlt|           | Hyper|   Y  |   U  |   I  |   O  |   P  |   '"   |
 * |--------+------+------+------+------+------| LGUI  |           |      |------+------+------+------+------+--------|
 * | LGUI   |   A  |   S  |   D  |   F  |   G  |-------|           |------|   H  |   J  |   K  |   L  |; / L2| Enter  |
 * |--------+------+------+------+------+------| LGUI  |           | RGUI |------+------+------+------+------+--------|
 * | LShift |Z/Ctrl|   X  |   C  |   V  |   B  |       |           |      |   N  |   M  |   ,  |   .  |//Ctrl| RShift |
 * `--------+------+------+------+------+--------------'           `-------------+------+------+------+------+--------'
 *   | TT1  |  -_  | Alt  | Left | Right|                                       |  Up  | Down |   [  |   ]  | TT1  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        KC_TAB,         KC_Q,         KC_W,   KC_E,   KC_R,   KC_T,   LCA(KC_LGUI),
        KC_LGUI,        KC_A,         KC_S,   KC_D,   KC_F,   KC_G,
        KC_LSFT,        CTL_T(KC_Z),  KC_X,   KC_C,   KC_V,   KC_B,   KC_LGUI,
        TT(SYMB),       KC_MINS,      KC_LALT,KC_LEFT,KC_RGHT,
                                              KC_ESC, KC_LGUI,
                                                              KC_HOME,
                                              KC_SPC, KC_TAB, KC_END,
        // right hand
             KC_RGHT,  KC_6,   KC_7,  KC_8,   KC_9,   KC_0,             KC_BSPC,
             KC_HYPR,  KC_Y,   KC_U,  KC_I,   KC_O,   KC_P,             KC_QUOT,
...
[SYMB] = LAYOUT_ergodox(
       ...
       KC_DEL ,KC_HASH,KC_DLR, KC_LPRN,KC_RPRN,KC_GRV,
